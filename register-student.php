...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($fullName) || empty($email) || empty($password) || empty($confirmPassword)) {
        ...
        $result = registerUser($fullName, $email, $password, 'student');
        
        if ($result['success']) {
            $success = $result['message'];
            // Rediriger vers la page de connexion après 2 secondes
            header('Refresh: 2; URL=login-student.php');
        } else {
...
<head>
    ...
    <title>Inscription Étudiant - Académie IA</title>
...
<body class="bg-gray-50 min-h-screen flex items-center justify-center p-4">
    <div class="max-w-md w-full space-y-6 animate-fade-in">
        <div class="text-center">
            ...
            <p class="text-gray-600">Inscription Étudiant</p>
        </div>
        ...
        <div class="text-center">
            ...
            <a href="login-student.php" class="text-blue-600 hover:text-blue-700 font-medium">
                Se connecter
            </a>
        </div>
